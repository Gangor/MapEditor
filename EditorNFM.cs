...
namespace MapEditor
{
    public partial class EditorNFM : Form
    {
        ...
        public EditorNFM(string title, NfmManager manager)
        {
            cache = (Bitmap)MapManager.Instance.Map.Clone();
            map = (Bitmap)cache.Clone();
        ...
        {
            mapPictureBox.DataBindings.Add(new Binding("Image", map, "", false, DataSourceUpdateMode.OnPropertyChanged));
            minimapPictureBox.DataBindings.Add(new Binding("Image", minimap, "", false, DataSourceUpdateMode.OnPropertyChanged));
        }
        ...
        private void speedGrassGrid_CurrentCellChanged(object sender, System.EventArgs e)
        {
            ...
            propertyGrid1.SelectedObject = (speedGrassGrid.SelectedCells.Count == 1) ? speedGrassGrid.Rows[speedGrassGrid.CurrentCell.RowIndex].DataBoundItem : null;
        }
        ...
        {
            var nX1 = (segment.X) * Global.titleLenght * 6 / 7.875f;
            var nY1 = (segment.Y) * Global.titleLenght * 6 / 7.875f;
            var nX2 = (segment.X + 1) * Global.titleLenght * 6 / 7.875f;
            var nY2 = (segment.Y + 1) * Global.titleLenght * 6 / 7.875f;

            var pointC = MapManager.Instance.GetPointRotate180FlipY(new PointF(nX1, nY1));
            var pointB = MapManager.Instance.GetPointRotate180FlipY(new PointF(nX2, nY2));
        ...
        {
            var nX1 = ((segment.X * Global.titleLenght * 6 / 7.875f) + ((tile.X * Global.titleLenght / 7.875f)));
            var nY1 = ((segment.Y * Global.titleLenght * 6 / 7.875f) + ((tile.Y * Global.titleLenght / 7.875f)));
            var nX2 = ((segment.X * Global.titleLenght * 6 / 7.875f) + ((tile.X + 1) * Global.titleLenght / 7.875f));
            var nY2 = ((segment.Y * Global.titleLenght * 6 / 7.875f) + ((tile.Y + 1) * Global.titleLenght / 7.875f));
            ...
            if (e.Button == MouseButtons.Left)
            {
                switch (CurrentMode)
                {
                    ...
                    case Mode.SEGMENT:
                        ...
                        if (Segments.Any(r => r == Segment)) break;
                    ...
                    case Mode.TILE:
                        ...
                        if (Segment.X > 63 || Segment.Y > 63) return;
                        if (Tiles.Any(r => r.tile == Tile && r.segment == Segment)) break;

                        Tiles.Add(new Tile() { segment = Segment, tile = Tile });
        ...
        {            
            var rotate180FlipY = MapManager.Instance.GetPointRotate180FlipY(new PointF((e.Location.X / zoom), (e.Location.Y / zoom)));
        ...
        private void InitializeSegment()
        {
            ...
            using (Graphics g = Graphics.FromImage(segmentMask))
            {
                ...
                for (int segmentY = 0; segmentY < 64; segmentY++)
                    ...
                    {
                        var x1 = ((segmentX / 7.875f * Global.titleLenght * 6));
                        var y1 = ((segmentY / 7.875f * Global.titleLenght * 6));
                        //
                        var x2 = (((segmentX + 1) / 7.875f * Global.titleLenght * 6));
                        var y2 = (((segmentY + 1) / 7.875f * Global.titleLenght * 6));
                        //
                        var pointa = MapManager.Instance.GetPointRotate180FlipY(new PointF(x1, y1));
                        var pointc = MapManager.Instance.GetPointRotate180FlipY(new PointF(x2, y2));
        ...
        private void InitializeTile()
        {
            ...
            using (Graphics g = Graphics.FromImage(tileMask))
            {
                ...
                for (int titleY = 0; titleY < 384; titleY++)
                    ...
                    {
                        var x1 = (int)Math.Round(((titleX * Global.titleLenght) / 7.875f));
                        var y1 = (int)Math.Round(((titleY * Global.titleLenght) / 7.875f));
                        //
                        var x2 = (int)Math.Round((((titleX + 1) * Global.titleLenght) / 7.875f));
                        var y2 = (int)Math.Round((((titleY + 1) * Global.titleLenght) / 7.875f));
                        //
                        var pointa = MapManager.Instance.GetPointRotate180FlipY(new PointF(x1, y1));
                        var pointc = MapManager.Instance.GetPointRotate180FlipY(new PointF(x2, y2));
        ...
        private void minimapPictureBox_MouseMove(object sender, MouseEventArgs e)
        {
            ...
            {                
                var location = new PointF((e.Location.X / minimapZoom) + angleLT.X, (e.Location.Y / minimapZoom) + angleLT.Y);
                var rotate180FlipY = MapManager.Instance.GetPointRotate180FlipY(location);
        ...
        public void minimapPicture_PointerChanged(object sender, EventArgs e)
        {
            ...
            using (var graphic = Graphics.FromImage(minimap))
            {
                ...
                normal = MapManager.Instance.GetPointRotate180FlipY(new PointF(((segmentX * Global.titleLenght * 6 + position.FirstOrDefault().X) / 7.875f), ((segmentY * Global.titleLenght * 6 + position.FirstOrDefault().Y) / 7.875f)));
                ...
                {
                    var point = MapManager.Instance.GetPointRotate180FlipY(new PointF(((segmentX * Global.titleLenght * 6 + position[i].X) / 7.875f), ((segmentY * Global.titleLenght * 6 + position[i].Y) / 7.875f)));
