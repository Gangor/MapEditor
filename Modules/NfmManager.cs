...
namespace MapEditor.Modules
{
    ...
    {
        public int[] SupportedVersion = { 16, 17, 19, 22 };
                    ...
                    for (int segmentY = 0; segmentY < SegmentCountPerMap; segmentY++)
                        for (int segmentX = 0; segmentX < SegmentCountPerMap; segmentX++)
                        {
                            ...
                            for (int p = 0; p < propcount; p++)
                            {
                                ...
                                prop.ScaleY = (Version >= 22) ? b.ReadSingle() : prop.ScaleX;
                                prop.ScaleZ = (Version >= 22) ? b.ReadSingle() : prop.ScaleX;
                                prop.PropNum = b.ReadUInt16();
                                prop.HeightLocked = (Version >= 22) ? b.ReadBoolean() : false;
                                prop.LockHeight = (Version >= 22) ? b.ReadSingle() : 0.0f;
                                prop.TextureGroup = (Version >= 22) ? b.ReadInt16() : (short)-1;
                                DwProps.Add(prop);
                            }
...
#region Event area
            ...
            {
                Blank();
                XLog.WriteLine(Levels.Error, "NfmManager::Load<Exception> -> {0}", exception);
            }
        }
...
#region Event area
            ...
            {
                XLog.WriteLine(Levels.Error, "NfmManager::Save<Exception> -> {0}", exception);
            }
        }
